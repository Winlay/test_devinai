                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="role" id="role" required
                                    ...
                                    <option value="responsable_entreprise" {{ old('role') == 'responsable_entreprise' ? 'selected' : '' }}>Responsable Entreprise</option>
                                ...
                                @foreach($entreprises as $entreprise)
                                    <div class="flex items-center">
                                        <input type="checkbox" name="entreprises[]" value="{{ $entreprise->id }}" id="entreprise_{{ $entreprise->id }}"
                                               {{ in_array($entreprise->id, old('entreprises', [])) ? 'checked' : '' }}
